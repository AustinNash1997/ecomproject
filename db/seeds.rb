...
tomb_raider.category = single_player
tomb_raider.product_id = '1'
tomb_raider.save
puts tomb_raider.errors.full_messages
...
black_ops.category = multiplayer
black_ops.product_id = '2'
black_ops.save
puts black_ops.errors.full_messages
...
assassins_creed_origins.category = single_player
assassins_creed_origins.product_id = '3'
assassins_creed_origins.save
puts assassins_creed_origins.errors.full_messages
puts 'ACO Created.'
...
apex.category = multiplayer
apex.product_id = '4'
apex.save
puts apex.errors.full_messages
...
rainbow.category = multiplayer
rainbow.product_id = '5'
rainbow.save
puts rainbow.errors.full_messages
...
sekiro.category = single_player
sekiro.product_id = '6'
sekiro.save
puts sekiro.errors.full_messages
